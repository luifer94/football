class SavingsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @saving.update(saving_params)
        format.html { redirect_to @saving, notice: 'La/el Saving fue actualizada satisfactoriamente.' }
  ...
  def destroy
    @saving.destroy
    respond_to do |format|
      format.html { redirect_to savings_url, notice: 'La/el Saving fue destruido satisfactoriamente.' }
