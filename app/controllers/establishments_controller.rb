class EstablishmentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @establishment.save
        format.html { redirect_to @establishment, mensaje: 'La/el Establishment fue creada satisfactoriamente.' }
  ...
  def update
    respond_to do |format|
      if @establishment.update(establishment_params)
        format.html { redirect_to @establishment, notice: 'La/el Establishment fue actualizada satisfactoriamente.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to establishments_url, notice: 'La/el Establishment fue destruido satisfactoriamente.' }
  ...
  private
    ...
    def establishment_params
       ...
       params.require(:establishment).permit( :name, field_ids:[])
    end
end
